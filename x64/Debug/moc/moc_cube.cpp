...
QT_MOC_LITERAL(9, 102, 7) // "cleanup"

    },
    "Cube\0xRotationChanged\0\0angle\0"
...
void Cube::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cube::xRotationChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cube::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cube::yRotationChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Cube::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cube::zRotationChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Cube::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void Cube::yRotationChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Cube::zRotationChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
